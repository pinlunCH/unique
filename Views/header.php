...
<div class="cover all-cover" id="bg" >
<img id="slideshow" src="imgs/denys-nevozhai-guNIjIuUcgY-unsplash (1).jpg" alt="unique stay"
      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-7">
          <div class="single">
            ...
            <input placeholder="Where to ..." autocomplete="off"class="bokgrp jost" type="text" name="destination" data-id="" id="place-input">
